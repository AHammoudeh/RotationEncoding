...
def add_noise2img(img0, sigma = 0.25):
...
#-------------
val_set = Dataset(list_paths=routes_source, batch_size=batch_size, DATASET=DATASET_generation_split,Img_noise= IMG_noise,
...
test_set = Dataset(list_paths=routes_source, batch_size=batch_size, DATASET=DATASET_generation_split,Img_noise= IMG_noise,
            registration_method =registration_method,folder_suffix = folder_suffix, mode='test')
testloader = torch.utils.data.DataLoader(test_set, batch_size=batch_size,shuffle=False)


test_set0 = Dataset(list_paths=routes_source, batch_size=batch_size, DATASET=DATASET_generation_split,Img_noise= IMG_noise,
